...
WITH seed_ts AS (SELECT NOW() AS base_ts)
INSERT INTO coupons (code, coupon_type, discount_rate, min_order_amount, start_at, end_at, per_user_limit, active, created_at, updated_at)
...
UNION ALL
SELECT 'n11-deneme', 'GLOBAL', 10.00,   10.00, base_ts, base_ts + INTERVAL '10 months', 1, TRUE, base_ts, base_ts FROM seed_ts;
